        ...
        <AlertDialogContent data-testid="start-confirm-dialog">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              Once started, it will place real CARRYFORWARD LIMIT orders automatically — it takes both directions: <b>SHORT on {state.settings?.entry_bricks} red brick{state.settings?.entry_bricks > 1 ? "s" : ""}</b> and <b>LONG on {state.settings?.entry_bricks} green brick{state.settings?.entry_bricks > 1 ? "s" : ""}</b>, and if the market is already trending it will <b>enter immediately</b> in that direction.
